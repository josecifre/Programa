...
Partial Public Class ucComoConociste
    ...
    Dim CampoInicialBusqueda As String = "ComoConociste"
    Dim TablaMantenimiento As String = "ComoConociste"
    ...
    Private Sub ucASunto_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        SentenciaSQL = "SELECT * FROM " & TablaMantenimiento & " ORDER BY ComoConociste"
        ...
        txtComoConociste.DataBindings.Add(New Binding("EditValue", BinSrc, "ComoConociste", True))
    ...
    Private Sub ConfigurarGrid()
        ...
        Gv.Columns("ComoConociste").Caption = "Como Conociste"
        ...
        Gv.Columns("ComoConociste").SummaryItem.FieldName = "Contador"
        Gv.Columns("ComoConociste").SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Count
        Gv.Columns("ComoConociste").SummaryItem.DisplayFormat = "Total: {0:n0}"
...
#Region "Mantenimiento Asunto"
    ...
    Private Sub Modificar(Optional PonermeEnLaPrimeraColumna As Boolean = True)
        ...
        EstoyEnAlta = False
        ValorAntesModificar = txtComoConociste.EditValue
    ...
    Private Sub Eliminar()
        ...
        If Not PuedeEliminar("COMOCONOCISTE", txtComoConociste.EditValue) Then
   ...
   Private Sub HabilitarDesHabilitarCajas(Habilitar As Boolean)
    ...
    Private Function Actualizar() As Boolean
        Try
            ...
            Cargando = True
            BinSrc.EndEdit()
            ValorDespuesDeModificar = txtComoConociste.EditValue
            Cargando = False
            ...
            If Not EstoyEnAlta AndAlso (ValorDespuesDeModificar <> ValorAntesModificar) Then
                ...
                Sel = "UPDATE Clientes SET ComoConociste = '" & Funciones.pf_ReplaceComillas(ValorDespuesDeModificar) & "' WHERE ComoConociste = '" & Funciones.pf_ReplaceComillas(ValorAntesModificar) & "'"
                BD_CERO.Execute(Sel)
            End If
    ...
    Private Function ComprobarDatos() As Boolean
        ...
        If txtComoConociste.Text.ToString.Trim = "" Then
            MensajeError("El campo Como Conociste no puede estar vacío")
            txtComoConociste.Focus()
            Return False
        End If
