...
Partial Public Class ucAgrupaciones
    ...
    Dim CampoInicialBusqueda As String = "Agrupacion"
    Dim TablaMantenimiento As String = "Agrupaciones"
    ...
    Private Sub ucASunto_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        SentenciaSQL = "SELECT * FROM " & TablaMantenimiento & " ORDER BY Agrupacion"
        ...
        txtAgrupacion.DataBindings.Add(New Binding("EditValue", BinSrc, "Agrupacion", True))
    ...
    Private Sub ConfigurarGrid()
        ...
        Gv.Columns("Agrupacion").Caption = "Agrupación"
        ...
        Gv.Columns("Agrupacion").SummaryItem.FieldName = "Contador"
        Gv.Columns("Agrupacion").SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Count
        Gv.Columns("Agrupacion").SummaryItem.DisplayFormat = "Total: {0:n0}"
...
#Region "Mantenimiento Asunto"
    ...
    Private Sub Modificar(Optional PonermeEnLaPrimeraColumna As Boolean = True)
        ...
        EstoyEnAlta = False
        ValorAntesModificar = txtAgrupacion.EditValue
    ...
    Private Sub Eliminar()
        ...
        If Not PuedeEliminar("AGRUPACION", txtAgrupacion.EditValue) Then
    ...
    Private Function Actualizar() As Boolean
        Try
            ...
            Cargando = True
            BinSrc.EndEdit()
            ValorDespuesDeModificar = txtAgrupacion.EditValue
            Cargando = False
            ...
            If Not EstoyEnAlta AndAlso (ValorDespuesDeModificar <> ValorAntesModificar) Then
                Dim Sel As String = ""
                Sel = "UPDATE Inmuebles SET Agrupacion = '" & Funciones.pf_ReplaceComillas(ValorDespuesDeModificar) & "' WHERE Agrupacion = '" & Funciones.pf_ReplaceComillas(ValorAntesModificar) & "'"
                ...
                BD_CERO.Execute(Sel)
                Sel = "UPDATE Clientes SET Agrupacion = '" & Funciones.pf_ReplaceComillas(ValorDespuesDeModificar) & "' WHERE Agrupacion = '" & Funciones.pf_ReplaceComillas(ValorAntesModificar) & "'"
                BD_CERO.Execute(Sel)
            End If
            FuncionesBD.Accion("REHACER", TablaMantenimiento)
            HabilitarBotones()
    ...
    Private Function ComprobarDatos() As Boolean
        ...
        If txtAgrupacion.Text.ToString.Trim = "" Then
            MensajeError("El campo agrupación no puede estar vacío")
            txtAgrupacion.Focus()
            Return False
        End If
