...
Partial Public Class ucProvincias
    ...
    Dim CampoInicialBusqueda As String = "Provincia"
    Dim TablaMantenimiento As String = "Provincias"
    ...
    Private Sub ucASunto_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        SentenciaSQL = "SELECT * FROM " & TablaMantenimiento & " ORDER BY Provincia"
    ...
    Private Sub ConfigurarGrid()
        ...
        Gv.Columns("Provincia").SummaryItem.FieldName = "Contador"
        Gv.Columns("Provincia").SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Count
        Gv.Columns("Provincia").SummaryItem.DisplayFormat = "Total: {0:n0}"
...
#Region "Mantenimiento Asunto"
    ...
    Private Sub Modificar(Optional PonermeEnLaPrimeraColumna As Boolean = True)
        ...
        EstoyEnAlta = False
        ValorAntesModificar = txtProvincia.EditValue
    ...
    Private Function Actualizar() As Boolean
        Try
            ...
            BinSrc.EndEdit()
            Cargando = False
            ValorDespuesDeModificar = txtProvincia.EditValue
    ...
    Private Function ComprobarDatos() As Boolean
        ...
        If txtProvincia.Text.ToString.Trim = "" Then
