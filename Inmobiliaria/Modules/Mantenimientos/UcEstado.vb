...
Partial Public Class ucEstado
    ...
    Dim CampoInicialBusqueda As String = "Estado"
    Dim TablaMantenimiento As String = "Estado"
    ...
    Private Sub ucASunto_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        SentenciaSQL = "SELECT * FROM " & TablaMantenimiento & " ORDER BY Estado"
        ...
        txtEstado.DataBindings.Add(New Binding("EditValue", BinSrc, "Estado", True))
        TxtPrioridad.DataBindings.Add(New Binding("EditValue", BinSrc, "Prioridad", True))
        TxtTipPrioridad.DataBindings.Add(New Binding("EditValue", BinSrc, "TipoPrioridad", True))
        TxtListado.DataBindings.Add(New Binding("EditValue", BinSrc, "Listado", True))
        TxtListadoRevista.DataBindings.Add(New Binding("EditValue", BinSrc, "ListadoRevista", True))
        FuncionesGenerales.Funciones.PrepararCombo(BinSrc, cmbClasificacionWeb, "EstadosWeb", "ClasificacionWeb", "ClasificacionWeb",,,, "SELECT '' AS ClasificacionWeb UNION ALL SELECT ClasificacionWeb FROM EstadosWeb ORDER BY ClasificacionWeb")
    ...
    Private Sub ConfigurarGrid()
        ...
        Gv.Columns("ListadoRevista").Caption = "Listado Revista"

        Gv.Columns("ListadoRevista").Visible = False
        Gv.Columns("ListadoRevista").OptionsColumn.AllowShowHide = False
        Gv.Columns("Listado").Visible = False
        Gv.Columns("Listado").OptionsColumn.AllowShowHide = False
        ...
        Gv.Columns("Estado").SummaryItem.FieldName = "Contador"
        Gv.Columns("Estado").SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Count
        Gv.Columns("Estado").SummaryItem.DisplayFormat = "Total: {0:n0}"
...
#Region "Mantenimiento Asunto"
    ...
    Private Sub Modificar(Optional PonermeEnLaPrimeraColumna As Boolean = True)
        ...
        EstoyEnAlta = False
        ValorAntesModificar = txtEstado.EditValue
    ...
    Private Sub Eliminar()
        ...
        'If DatosUsuario.usuario = txtUsuario.Text Then
        '    MensajeError("No puede eliminarse a si mismo")
        '    Exit Sub
        'End If

        If Not PuedeEliminar("ESTADO", txtEstado.EditValue) Then
    ...
    Private Function Actualizar() As Boolean
        Try
            ...
            Cargando = True
            BinSrc.EndEdit()
            ValorDespuesDeModificar = txtEstado.EditValue
            Cargando = False
            ...
            If Not EstoyEnAlta AndAlso (ValorDespuesDeModificar <> ValorAntesModificar) Then
                ...
                Sel = "UPDATE ClientesEstado SET Estado = '" & Funciones.pf_ReplaceComillas(ValorDespuesDeModificar) & "' WHERE Estado = '" & Funciones.pf_ReplaceComillas(ValorAntesModificar) & "'"
                ...
                Sel = "UPDATE Inmuebles SET Estado = '" & Funciones.pf_ReplaceComillas(ValorDespuesDeModificar) & "' WHERE Estado = '" & Funciones.pf_ReplaceComillas(ValorAntesModificar) & "'"
                BD_CERO.Execute(Sel)
    ...
    Private Function ComprobarDatos() As Boolean
        ...
        If txtEstado.Text.ToString.Trim = "" Then
            MensajeError("El campo estado no puede estar vacío")
            txtEstado.Focus()
            Return False
        End If
        ...
        'If TxtTipPrioridad.Text.ToString.Trim = "" Then
        '    MensajeError("El campo tipo prioridad no puede estar vacío")
        '    TxtTipPrioridad.Focus()
        '    Return False
        'End If


        'If TxtListado.Text.ToString.Trim = "" Then
        '    MensajeError("El campo listado no puede estar vacío")
        '    TxtListado.Focus()
        '    Return False
        'End If


        'If TxtListadoRevista.Text.ToString.Trim = "" Then
        '    MensajeError("El campo listado revista no puede estar vacío")
        '    TxtListadoRevista.Focus()
        '    Return False
        'End If
