...
Partial Public Class ucOrientacion
    ...
    Dim CampoInicialBusqueda As String = "Orientacion"
    Dim TablaMantenimiento As String = "Orientacion"
    ...
    Private Sub ucASunto_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        SentenciaSQL = "SELECT * FROM " & TablaMantenimiento & " ORDER BY Orientacion"
        ...
        txtOrientacion.DataBindings.Add(New Binding("EditValue", BinSrc, "Orientacion", True))
    ...
    Private Sub ConfigurarGrid()
        ...
        Gv.Columns("Orientacion").Caption = "Orientación"
        ...
        Gv.Columns("Orientacion").SummaryItem.FieldName = "Contador"
        Gv.Columns("Orientacion").SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Count
        Gv.Columns("Orientacion").SummaryItem.DisplayFormat = "Total: {0:n0}"
...
#Region "Mantenimiento Asunto"
    ...
    Private Sub Modificar(Optional PonermeEnLaPrimeraColumna As Boolean = True)
        ...
        EstoyEnAlta = False
        ValorAntesModificar = txtOrientacion.EditValue
    ...
    Private Sub Eliminar()
        ...
        If Not PuedeEliminar("ORIENTACION", txtOrientacion.EditValue) Then
    ...
    Private Function Actualizar() As Boolean
        Try
            ...
            Cargando = True
            BinSrc.EndEdit()
            ValorDespuesDeModificar = txtOrientacion.EditValue
            Cargando = False
            ...
            If Not EstoyEnAlta AndAlso (ValorDespuesDeModificar <> ValorAntesModificar) Then
                Dim Sel As String = ""
                Sel = "UPDATE ClientesOrientacion SET Orientacion = '" & Funciones.pf_ReplaceComillas(ValorDespuesDeModificar) & "' WHERE Orientacion = '" & Funciones.pf_ReplaceComillas(ValorAntesModificar) & "'"
                ...
                BD_CERO.Execute(Sel)
                Sel = "UPDATE Inmuebles SET Orientacion = '" & Funciones.pf_ReplaceComillas(ValorDespuesDeModificar) & "' WHERE Orientacion = '" & Funciones.pf_ReplaceComillas(ValorAntesModificar) & "'"
                BD_CERO.Execute(Sel)
    ...
    Private Function ComprobarDatos() As Boolean
        ...
        If txtOrientacion.Text.ToString.Trim = "" Then
            MensajeError("El campo Orientación no puede estar vacío")
            txtOrientacion.Focus()
            Return False
        End If
