    ...
    Class MAPI
        ...
        Private Function SendMail(ByVal strSubject As String, ByVal strBody As String, ByVal how As Integer) As Integer
            ...
            If m_lastError > 1 Then
                ...
                MessageBox.Show("Fallo en MAPISENDMAIL! " + GetLastError(), "MAPISendMail")
