...
Public Class rptListadoClientes
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TrabajarEuros() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptListadoClientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListadoClientes = New rptListadoClientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
